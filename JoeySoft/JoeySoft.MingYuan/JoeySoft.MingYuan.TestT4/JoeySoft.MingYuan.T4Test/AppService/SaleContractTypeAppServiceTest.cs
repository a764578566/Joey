...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.AppServices
{
    ...
    /// </summary>
    [TestFixture]
    public class SaleContractTypeAppServiceTest
    {
		private readonly SaleContractTypeAppService _saleContractTypeAppService = new SaleContractTypeAppService();

        private readonly StubSaleContractTypeDomainService _saleContractTypeDomainService = new StubSaleContractTypeDomainService();
        
        private readonly StubFormEntityDomainService _formEntity = new StubFormEntityDomainService();

        private readonly EntityMocker<SaleContractType> _saleContractTypeMock = new EntityMocker<SaleContractType>();
        ...
        public void InitResource()
        {
            ...
            TestMockServiceResolver.RegisterInstance<SaleContractTypeDomainService, StubSaleContractTypeDomainService>(_saleContractTypeDomainService);
