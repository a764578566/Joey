...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.AppServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ProviderTypeAppServiceTest
    {
		private readonly ProviderTypeAppService _providerTypeAppService = new ProviderTypeAppService();

        private readonly StubProviderTypeDomainService _providerTypeDomainService = new StubProviderTypeDomainService();
        
        private readonly StubFormEntityDomainService _formEntity = new StubFormEntityDomainService();

        private readonly EntityMocker<ProviderType> _providerTypeMock = new EntityMocker<ProviderType>();
        ...
        public void InitResource()
        {
            ...
            TestMockServiceResolver.RegisterInstance<ProviderTypeDomainService, StubProviderTypeDomainService>(_providerTypeDomainService);
