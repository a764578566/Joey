...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.AppServices
{
    ...
    /// </summary>
    [TestFixture]
    public class FundParamAppServiceTest
    {
		private readonly FundParamAppService _fundParamAppService = new FundParamAppService();

        private readonly StubFundParamDomainService _fundParamDomainService = new StubFundParamDomainService();
        ...
        public void InitResource()
        {
            ...
            TestMockServiceResolver.RegisterInstance<FundParamDomainService, StubFundParamDomainService>(_fundParamDomainService);
