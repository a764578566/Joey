...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.AppServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ProjectOverviewAppServiceTest
    {
		private readonly ProjectOverviewAppService _projectOverviewAppService = new ProjectOverviewAppService();

        private readonly StubProjectOverviewDomainService _projectOverviewDomainService = new StubProjectOverviewDomainService();
        ...
        public void InitResource()
        {
            ...
            TestMockServiceResolver.RegisterInstance<ProjectOverviewDomainService, StubProjectOverviewDomainService>(_projectOverviewDomainService);
