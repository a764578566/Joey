...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class SaleContractTypeDomainServiceTest
    {
		private readonly SaleContractTypeDomainService _saleContractTypeDomainService = new SaleContractTypeDomainService();
        ...
        private readonly string _saleContractTypeFileJsonName = "SaleContractType.json";
        ...
        public void InitResource()
        {
            ...
            _saleContractTypeMock.LoadData(_saleContractTypeFileJsonName);
        }
