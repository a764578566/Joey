...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    {
		private readonly TaxItemDomainService _taxItemDomainService = new TaxItemDomainService();
        ...
        private readonly string _taxItemFileJsonName = "TaxItem.json";
        ...
        public void InitResource()
        {
            ...
            _taxItemMock.LoadData(_taxItemFileJsonName);
        }
