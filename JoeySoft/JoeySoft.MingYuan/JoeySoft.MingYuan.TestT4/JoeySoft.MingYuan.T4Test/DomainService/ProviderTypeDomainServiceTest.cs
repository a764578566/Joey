...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ProviderTypeDomainServiceTest
    {
		private readonly ProviderTypeDomainService _providerTypeDomainService = new ProviderTypeDomainService();
        ...
        private readonly string _providerTypeFileJsonName = "ProviderType.json";
        ...
        public void InitResource()
        {
            ...
            _providerTypeMock.LoadData(_providerTypeFileJsonName);
        }
