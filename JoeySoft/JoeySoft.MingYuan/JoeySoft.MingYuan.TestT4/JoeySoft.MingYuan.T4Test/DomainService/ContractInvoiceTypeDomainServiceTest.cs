...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ContractInvoiceTypeDomainServiceTest
    {
		private readonly ContractInvoiceTypeDomainService _contractInvoiceTypeDomainService = new ContractInvoiceTypeDomainService();
        ...
        private readonly string _contractInvoiceTypeFileJsonName = "ContractInvoiceType.json";
        ...
        public void InitResource()
        {
            ...
            _contractInvoiceTypeMock.LoadData(_contractInvoiceTypeFileJsonName);
        }
