...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class PricePolicyDomainServiceTest
    {
		private readonly PricePolicyDomainService _pricePolicyDomainService = new PricePolicyDomainService();
        ...
        private readonly string _pricePolicyFileJsonName = "PricePolicy.json";
        ...
        public void InitResource()
        {
            ...
            _pricePolicyMock.LoadData(_pricePolicyFileJsonName);
        }
