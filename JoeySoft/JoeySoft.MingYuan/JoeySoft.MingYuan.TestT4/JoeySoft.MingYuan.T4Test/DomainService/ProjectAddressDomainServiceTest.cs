...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ProjectAddressDomainServiceTest
    {
		private readonly ProjectAddressDomainService _projectAddressDomainService = new ProjectAddressDomainService();
        ...
        private readonly string _projectAddressFileJsonName = "ProjectAddress.json";
        ...
        public void InitResource()
        {
            ...
            _projectAddressMock.LoadData(_projectAddressFileJsonName);
        }
