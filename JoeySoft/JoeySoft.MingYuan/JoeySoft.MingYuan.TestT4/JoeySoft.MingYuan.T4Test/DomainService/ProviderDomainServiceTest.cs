...
namespace Mysoft.Clgyl.ProjectPrep.UnitTest.DomainServices
{
    ...
    /// </summary>
    [TestFixture]
    public class ProviderDomainServiceTest
    {
		private readonly ProviderDomainService _providerDomainService = new ProviderDomainService();
        ...
        private readonly string _providerFileJsonName = "Provider.json";
        ...
        public void InitResource()
        {
            ...
            _providerMock.LoadData(_providerFileJsonName);
        }
